...
if (isset($_GET['productID'])) {
    ...
    $productID =  mysqli_real_escape_string($dbCon->getConn(),$_GET['productID']);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient bg-dark sticky-top shadow-lg py-2">
    ...
    <div class="container mt-5 pb-5">
       ...
       <div class="row">
           <div class="col-md-6">
               <img src="<?php echo "admin/product_images/".$getProduct['productImage']; ?>" class="img-fluid rounded" width="540px" height="540px">
           </div>
           <div class="col-md-6"> 
               <div class="row">
                   <div class="col-md-12 mt-4">
                       <h1><?php echo $getProduct['productName'] ?></h1>
                   </div>
               </div>     
               <div class="row">
                   <div class="col-md-12">
                       <span class="badge badge-success my-3">Product ID</span>
                       <span class="product-number"><?php echo $getProduct['productID'] ?></span>
                   </div>
               </div> 
                                 
               <div class="row mt-2">
                   <div class="col-md-12 text-danger">
                       <h4 id="product-price">R<?php echo number_format($getProduct['productPrice']) ?></h4>                        
                   </div>
               </div>
               <div class="row mt-2">
                   <div class="col-md-12">
                       <button id="myBtn" class="btn text-dark mt-auto" onclick="addCart('<?php echo $productID; ?>')">                            
               ...
               <div class="row my-5">
                   <div class="col-md-12">
                       <div id="description">
                            <?php echo $getProduct['productDescription'] ?>
                        </div>
                   </div>
               </div>    
