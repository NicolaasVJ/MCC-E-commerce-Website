            ...
            <div class="mt-5 d-block ">
                <ul class="nav nav-pills nav-fill border-0 rounded-0">
                    <li class="flex-grow-1 text-center nav-item">
                        <a href="" class="m-0 px-0 py-2 bg-secondary text-muted nav-link disabled  font-weight-bold rounded-1 nav-link border-right">Account details</a>
                    </li>
            </div>
                ...
                <form action="POST">
                    <div class="row">
                        ...
                        <form method="get">
                            ...
                            <div class="form-group">
                                <label for="customerCell">Cell Number</label>
                                <input disabled="disabled" type="text" class="form-control" placeholder="Cellnumber" required value="<?php echo $result['cellNumber']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="customerAddress">Address</label>
                                <input disabled="disabled" type="text" class="form-control" placeholder="Address" required value="<?php echo $result['address']; ?>">
                            </div>
                            <a class="btn btn-info form-control" style="cursor: pointer;" data-toggle="modal" data-target="#customerUpdateModal" data-dismiss="modal">Update information</a>
                            </form>
                        </div>
                    </div>
                </form>
